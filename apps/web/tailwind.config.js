  ...
  theme: {
    extend: {
      colors: {
        ...
        // Custom orange scale (accents & "over")
        'brand-orange': {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
        ...
        // Custom teal scale (highlights & "under")
        'brand-teal': {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
      ...
      boxShadow: {
        ...
        'elevation-4': '0 20px 25px -5px rgba(0, 0, 0, 0.3), 0 10px 10px -5px rgba(0, 0, 0, 0.2)',
      },
      backgroundImage: {
        'gradient-purple-orange': 'linear-gradient(135deg, #a855f7 0%, #f97316 100%)',
