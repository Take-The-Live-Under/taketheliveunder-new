                ...
                <div className="rounded-xl border border-neutral-800 p-5 glass-panel space-y-4">
                  <div>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-neutral-500 font-mono mt-0.5">
                          ...
                          {analysis.team.record ||
                            `${analysis.team.games_played} games`}
                        </p>
                      </div>
                    ...
                    {analysis.classifications.length > 0 && (
                      <div className="mb-3">
                        <div className="text-[10px] text-neutral-600 font-mono mb-1.5">
                          // CLASSIFICATIONS
                        </div>
                        <div className="flex flex-wrap gap-1.5">
                          {analysis.classifications.map((c) => (
                            <span
                              key={c.id}
                              className={`px-2 py-0.5 text-[10px] font-medium rounded-lg border font-mono ${getClassificationColor(c.color)}`}
                              title={c.description}
                            >
                              {c.label}
                            </span>
                      ...
                      <div>
                        ...
                        <ul className="space-y-1">
                          {analysis.insights.map((insight, i) => (
                            ...
                            >
                              <span className="text-[#00ffff]/50 mt-0.5 flex-shrink-0">
                                ›
                              </span>
                              {insight}
                            </li>
                  ...
                  {compareAnalysis && (
                    <div className="pt-3 border-t border-neutral-800">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <div className="text-[10px] text-neutral-600 font-mono mb-0.5">
                            vs.
                          </div>
                  ...
                  {showCompareInput && !compareTeam && (
                    <div className="relative">
                      <label className="block text-[10px] text-neutral-600 font-mono mb-1.5">
                      ...
                      >
                        ...
                        <div className="divide-y divide-neutral-800/60">
                          {categoryMetrics.map((metric) => {
                            ...
                            const percentile =
                              analysis.percentiles[metric.key] || 50;
                            ...
                            const leagueAvg =
                              analysis.leagueAverages[metric.key];
                            return (
                                ...
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <div className="text-right">
                                    ...
                                    {leagueAvg !== undefined && (
                                      <span className="text-xs text-neutral-600 ml-2">
                                        avg{" "}
                                        {formatValue(leagueAvg, metric.format)}
                                      </span>
                                    )}
                                  </div>
                                </div>
                      ...
                      >
                        ...
                        <div className="divide-y divide-neutral-800/60">
                          {categoryMetrics.map((metric) => {
                            ...
                            const val2 = compareAnalysis.team[
                              metric.key
                            ] as number;
