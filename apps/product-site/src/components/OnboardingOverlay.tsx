...
export default function OnboardingOverlay({
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "PACE_ANALYSIS",
      description:
        "We calculate scoring pace (Points Per Minute) and compare it against the required pace to hit the over/under line.",
    },
    {
      step: "03",
      title: "GET_ALERTS",
      description:
        "Want to know when the model triggers? Join our Discord for real-time notifications.",
      isDiscord: true,
    },
  ];
      ...
      <div className="w-full max-w-md text-center animate-fade-in">
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              className={`h-1 rounded-full transition-all duration-300 ${
                i === step ? "w-8 bg-[#00ffff]" : "w-2 bg-neutral-800"
              }`}
            />
          ))}
        </div>
        ...
        <div className="flex justify-center mb-6">
          {currentStep.isDiscord ? (
            <div
              className="w-20 h-20 rounded-2xl border border-neutral-800 flex items-center justify-center"
        ...
        <div className="flex flex-col gap-3">
          {currentStep.isDiscord && (
            <a
              ...
              className="w-full py-4 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold transition-colors flex items-center justify-center gap-2"
            >
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold transition-all ${
              currentStep.isDiscord
                ? "border border-neutral-800 text-neutral-400 hover:bg-neutral-800/50 hover:text-white"
